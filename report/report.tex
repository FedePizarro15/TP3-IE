...
\begin{figure}[H]
    \centering
    \subfloat[$\sigma^2 = 4$]{\includegraphics[width=0.5\textwidth]{noise_v_4.png}}\hfill
    % \subfloat[$\sigma^2 = 25$]{\includegraphics[width=0.5\textwidth]{noise_v_25.png}}\hfill
    \subfloat[$\sigma^2 = 100$]{\includegraphics[width=0.5\textwidth]{noise_v_100.png}}
...
\begin{figure}[H]
    \centering
    \subfloat[\texttt{config\_2}]{\includegraphics[width=0.5\textwidth]{cond_2.png}}\hfill
    % \subfloat[\texttt{config\_3}]{\includegraphics[width=0.5\textwidth]{cond_3.png}}
    \subfloat[\texttt{config\_4}]{\includegraphics[width=0.5\textwidth]{cond_4.png}}
